...
* [Configs Directory]: Contains complete production running configurations for the Edge Router, ISP platform, and Core switches.
* [Images Directory]: Topology diagrams, flowcharts, and system metrics documentation.
